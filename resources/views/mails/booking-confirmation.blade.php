<x-guest-layout>
    <section class="max-w-2xl px-12 py-8 mx-auto bg-white dark:bg-gray-900">
        <header>
            <a href="#" class="flex align-middle justify-center text-xl font-bold">
                Event Booking Confirmation
            </a>
        </header>

        <main class="mt-8">
            <h2 class="mt-6 text-gray-700 dark:text-gray-200">Hi {{ $bookingData['attendee_name'] }},</h2>

            <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
                This email serves as your confirmation for your booking of 
            ...
            <h2 class="mt-6 text-gray-700 font-bold dark:text-gray-200">Event Details:</h2>

            <ui>
                <li class="ps-3 text-gray-600 dark:text-gray-300">Date: {{ $bookingData['booking_date'] }}</li>
                <li class="ps-3 text-gray-600 dark:text-gray-300">Time: {{ $bookingData['booking_time'] }}</li>
                <li class="ps-3 mb-10 text-gray-600 dark:text-gray-300">Duration: {{ $bookingData['duration'] }} minutes</li>
            </ui>
        ...
        <footer class="mt-8 text-center">
            <h3 class="text-gray-500 dark:text-gray-400">Access our App</h3>
            <a href="#" class="mt-2 font-bold text-gray-800 dark:text-white">Booking Buddy</a>
            ...
            <div class="mt-6">
                <a href="#"
                    ...
                    <svg class="w-5 h-5 mx-2 fill-current" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <p class="mt-6 text-gray-500 dark:text-gray-400">
                This email was sent to <a href="#" class="text-blue-600 hover:underline dark:text-blue-400"
                    target="_blank">{{ $bookingData['attendee_email'] }}</a>.
